...
public class PacienteController {
    ...
    @GetMapping("/{id}") //localhost:8081/pacientes/x
    ...
    //PUT
    @PutMapping("/actualizar/{id}")//localhost:8081/pacientes/actualizar/x
    ...
    //DELETE
    @DeleteMapping("/eliminar")//localhost:8081/pacientes/eliminar?id=x
